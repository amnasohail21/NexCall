...
import WriteUserToDB from "../components/WriteUserToDB";
      ...
      <div className="w-full h-screen bg-gradient-to-b from-gray-900 to-black text-white flex">
        <aside className="w-[340px] p-6 border-r border-black/40 flex flex-col">
          ...
          <div className="flex flex-col gap-4 overflow-auto max-h-[70vh] pr-2">
            {users.length === 0 && (
              <div className="text-gray-400">No users found (add users in Firebase)</div>
            )}
            {users.map((u) => (
              <div
                key={u.id}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">{u.status || "Available"}</div>
                  </div>
                </div>
                <div>
                  <button
        ...
        <main className="flex-1 relative">
          {selectedRoom ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center text-center px-6">
              ...
              <p className="text-gray-400 mb-6">Select a contact on the left to start a call</p>
